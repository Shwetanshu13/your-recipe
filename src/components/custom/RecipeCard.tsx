...
const RecipeCard = ({ name, ingredients, instructions, time, _id }: RecipeCardProp) => {
    ...
    <div className="shadow-lg cursor-pointer flex flex-col gap-3 p-7 bg-gray-200 hover:shadow-2xl rounded-xl">
      ...
      >
        ...
        <p className="text-gray-700 text-base">
          <b>Ingredients </b>: {ingredients.slice(0, 25)}{ingredients.length > 25 ? '...' : ''}
        </p>
        <p className="text-gray-700 text-base">
          <b>Instructions </b>: {instructions.slice(0, 25)}{ingredients.length > 25 ? '...' : ''}
        </p>
